...
export const ScreensArray2 = [
  { route: 'home', label: 'Home', type: Icons.Feather, icon: 'home', component: BottomTab, notification: 0, },
  { route: 'Inbox', label: 'My Inbox', type: Icons.Feather, icon: 'inbox', component: DrawerScreen2, notification: 9, },
  { route: 'Calendar', label: 'My Calendar', type: Icons.Feather, icon: 'calendar', component: DrawerScreen2, notification: 4, },
  { route: 'Documents', label: 'My Documents', type: Icons.Feather, icon: 'layers', component: DrawerScreen2, notification: 0, },
  { route: 'Activity', label: 'My Activity', type: Icons.Feather, icon: 'pie-chart', component: DrawerScreen2, notification: 2, },
  { route: 'Settings', label: 'Settings', type: Icons.Feather, icon: 'settings', component: DrawerScreen2, notification: 0, },
];
